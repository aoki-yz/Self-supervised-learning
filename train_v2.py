...
from moco.gaussian_blur import GaussianBlur
...
from moco.models.resnet_v2 import resnet50
...
def parse_option():
    ...
    # dataset
    parser.add_argument('--data-dir', type=str, default='/media/yunzhi/106ca0d1-afac-4458-95b6-d494f030972b/imagenet',  help='root director of dataset')
    ...
    parser.add_argument('--nce-k', type=int, default=128, help='num negative sampler')
    parser.add_argument('--nce-t', type=float, default=0.2, help='NCE temperature')
    ...
    parser.add_argument('--output-dir', type=str, default='./output_v2', help='output director')
